...
public:
    ...
    ImageWriter(string input_filename, string output_filename):
    ...
    int write(){
        ...
        //  Close the file.
        //
        input_file = fopen (input_filename.c_str(), "r" );
       ...
       // cout << "\n";
       // cout << "  BMP graphics information written to \"" << output_filename << "\".\n";
        //
        //  Terminate.
        //
       // cout << "\n";

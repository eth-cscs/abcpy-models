...
mpiCC -fPIC -O3 -I /usr/include/python3.7m/ -I /usr/lib/python3.7/site-packages/mpi4py/include/ -I /usr/lib/python3.7/site-packages/numpy/core/include/ -c model_wrap.cpp -o model_wrap.o

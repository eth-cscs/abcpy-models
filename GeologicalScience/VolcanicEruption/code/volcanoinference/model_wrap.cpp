...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_model(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg7 = &temp7;
  if (!PyArg_ParseTuple(args,(char *)"OOOOO:model",&obj0,&obj1,&obj2,&obj3,&obj4)) SWIG_fail;
  {
    MPI_Comm *ptr = (MPI_Comm *)0;
    int res = SWIG_AsPtr_MPI_Comm(obj0, &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "model" "', argument " "1"" of type '" "MPI_Comm""'"); 
    }
    arg1 = *ptr;
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "model" "', argument " "2"" of type '" "double""'");
  } 
  arg2 = static_cast< double >(val2);
  ecode3 = SWIG_AsVal_double(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "model" "', argument " "3"" of type '" "double""'");
  } 
  arg3 = static_cast< double >(val3);
  ecode4 = SWIG_AsVal_int(obj3, &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "model" "', argument " "4"" of type '" "int""'");
  } 
  arg4 = static_cast< int >(val4);
  res5 = SWIG_AsCharPtrAndSize(obj4, &buf5, &size5, &alloc5);
  if (!SWIG_IsOK(res5)) {
    SWIG_exception_fail(SWIG_ArgError(res5), "in method '" "model" "', argument " "5"" of type '" "char *""'");
  }  
  arg5 = reinterpret_cast< char * >(buf5);
  arg6 = static_cast< int >(size5 - 1);
  model(arg1,arg2,arg3,arg4,arg5,arg6,arg7);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"model", _wrap_model, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};

...
class SiameseSimilarities(Dataset):
    """
    This class defines a dataset returning pairs of similar and dissimilar examples. It has to be instanciated with a
...
class TripletSimilarities(Dataset):
    ...
    It has to be instanciated with a dataset of the class Similarities.
    """
    ...
    def __getitem__(self, index):
        """How can we deal with situation in which a given sample has no similar examples?"""
...
# DATASETS DEFINITION FOR SUMMARY STATISTICS:

...
class SABCDiffusion:
    ...
    def sample(self, observations, steps, epsilon, n_samples = 10000, n_samples_per_param = 1, beta = 2, delta = 0.2, v = 0.3, ar_cutoff = 0.05, resample = None, n_update = None, adaptcov = 1, full_output=0):
        ...
        for aStep in range(0 ,steps):
            ...
            new_parameters, new_distances, new_all_parameters, new_all_distances, index, acceptance = [list(t) for t in zip
                                                                                                           (*params_and_dists)]
...
class _RemoteContextSABCDiffusion:
    ...
    def _accept_parameter(self, seed):
        ...
        if self.accepted_cov_mat_bds == None:
            ...
            while True:
                self.kernel.set_parameters([theta[:2], self.accepted_cov_mat_bds.value(), theta[2]])

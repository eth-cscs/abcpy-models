...
globals [ empirical_data food_per_patch reference_T Boltz T Arrhenius adult_size juvenile_size cocoon_size ]
...
The full version of earthworm IBM it runs was originally described here:

...
to setup
  ...
  set empirical_data_m [ 0.31 0.34 0.35 0.43 0.5 0.54 0.61 0.69 0.69 0.67 0.69 0.64 0.68 0.66 0.66 0.68 ]
  set empirical_data_c [ 0 30 31 39 36 41 36 48 40 44 42 38 36 42 41 34 40 36 40 ]
...
to go
  if not any? turtles with [ breed != cocoons ] or ticks > 205 [ stop ]
  update-experiment
...
to update-experiment
  ...
  if ticks = 25
  [ ask patches [ set current_food (20 / count patches) ] ]
  if ticks > 25 and remainder (ticks - 25) 20 = 0
  [ ask patches [ set current_food (current_food + (20 / count patches)) ] ]
end
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot mean [ current_food ] of patches"
